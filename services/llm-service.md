...
id: llm-service
title: LLM Service
description: "Language model service providing roadmap scoring and prioritisation capabilities"
tags: [Production]
connections: []
metadata:
  serviceType: llm
...
Provides access to a large language model for roadmap scoring and prioritisation. Used by all skills in this skrpt.
